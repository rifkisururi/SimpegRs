...
<a href="{{ $dashboard_url }}"
    ...
    {{-- Small brand logo --}}
    <img src="{{ asset(config('adminlte.logo_paru', 'vendor/adminlte/dist/img/paru.jpg')) }}"
         alt="{{ config('adminlte.logo_img_alt', 'RSK PARU') }}"
         class="{{ config('adminlte.logo_img_class', 'brand-image-xl') }} logo-xs">

    {{-- Large brand logo --}}
    <img src="{{ asset(config('adminlte.logo_paru')) }}"
         alt="{{ config('adminlte.logo_img_alt', 'RSK PARU') }}"
